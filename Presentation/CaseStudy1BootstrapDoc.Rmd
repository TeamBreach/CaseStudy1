...
-The ten most popular canned beer styles, expand to see. 'Saison' and 'Witbier' are the only non-'American' styles in the top ten at positions nine and ten respectively. 
...
-Furthermore, 23 of the 100 unique styles are American. However, these 23% of styles constitute 62% of all craft cans. Calculations may be confirmed below. 
...
-Map of median ABV per state below. Utah is the only state that stands out as having a particularly low ABV. In contrast, KY and Washington DC have the highest median ABV at 6.25%.
...
-Colorado and Utah are different
It appears that 'American' beers, like American IPA and APA, are very popular. Despite being only 23 out of 
...
* This data focused on canned beer, what about bottled beer?

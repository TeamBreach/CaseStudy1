...
```{r bootstrap.show.code=FALSE, bootstrap.show.message=FALSE, bootstrap.show.warning=FALSE}
## Load Packages ##
library(ggplot2)
library(fiftystater)
library(plyr)
...
-Expand below to see the first 6 rows and perform a spot check for integrity

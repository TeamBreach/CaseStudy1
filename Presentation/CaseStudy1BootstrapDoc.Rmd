...
# Data
This section will describe the originial data and discuss mthods used to convert the raw data into a tidy dataset ready for analysis.  These steps are crucial for replication of the analysis as the raw data contained several anomalies which could prevent replication of the analysis presented later.
...
ABV does not have much variation. 'Lee Hill Series Vol. 5 Belgian Style Quadruple Ale' out of Colorado is the most alcoholic beer. Six out of the ten most alcoholic beers are 'Imperial' beers while two out of the five most alcoholic beers come from 'Upslope Brewing Company' out of Boulder Colorado. Similarly, four of the ten most alcoholic beers come from California.
